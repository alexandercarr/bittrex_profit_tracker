#credit: https://github.com/ndri/python-bittrex
...
class bittrex(object):
    ...
    def __init__(self, key, secret):
        ...
        self.encoded_secret = secret.encode('utf-8')
    ...
    def query(self, method, values={}):
        ...
        if method not in self.public:
            ...
            signature = hmac.new(self.encoded_secret, url.encode('utf-8'), hashlib.sha512).hexdigest()
